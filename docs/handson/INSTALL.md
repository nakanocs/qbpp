...
```bash
$ tar xf qbpp2025.11.11.tar.gz
```
The file name of the latest version may be different.
...
Since the license is node-locked, it is not necessary to run this command again
