...
## PyQUBO++ program for the partitioning problem
...
## PyQUBO++ program using vector operations
PyQUBO++ has rich vector operations that can simplify the code.
...
PyQUBO++ programs can be simplified by using these vector operations.
