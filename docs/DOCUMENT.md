...
7. [Multi-dimensional Variables and Expressions](MULTIDIM)
8. [Sum Functions for Multi-dimensional Arrays](SUM)
9. [Easy Solver Usage](EASYSOLVER)
10. [Exhaustive Solver Usage](EXHAUSTIVE)
11. [ABS3 Solver Usage](ABS3)
12. [Gurobi Optimizer Usage](GUROBI)
