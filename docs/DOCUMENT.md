...
5. [Expression Classes](EXPRESSION)
6. [Evaluating Expressions](EVAL)
7. [Replace functions](REPLACE)
8. [Multi-dimensional Variables and Expressions](MULTIDIM)
...
13. [Gurobi Optimizer Usage](GUROBI)
