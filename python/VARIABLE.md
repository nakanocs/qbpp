...
## Installing PyQUBO++
To use PyQUBO++, install it via pip:
```bash
$ pip install pyqbpp
```

## Importing the library
To use PyQUBO++, import the necessary functions from the **`pyqbpp`** module:
```python
...
> **NOTE**
> In PyQUBO++, most **member functions** update the object in place when possible, whereas **global functions** return a new value without modifying the original object.
