...
section: python
layout: default
title: "Comparison Operators (Python)"
---

# Comparison Operators
PyQUBO++ supports two types of operators for creating constraints:
...
PyQUBO++ supports the equality operator only in the following form:
- **`expression == integer`**
...
> **NOTE**
> Unlike the C++ version which uses the syntax `l <= f <= u`, PyQUBO++ uses the function `between(f, l, u)` for range constraints on expressions.
