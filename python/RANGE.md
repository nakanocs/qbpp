...
Using this auxiliary-variable technique, PyQUBO++ implements range constraints via the **`between()`** function.
...
The following PyQUBO++ program finds this optimal solution using the Easy Solver:
```python
